...
https://arxiv.org/html/2410.19811v1
...
Many of the beneﬁts derive from the fact that **systems engineering** and design tasks
in general usually require close collaboration and clear communication between stakeholders with
very diﬀerent backgrounds and areas of expertise [1–3]. Many of the issues that arise during this
work involve poor communication or unclear technical language being able to cross over between
domains. 
